typedef enum bucketSizeDuration { ms50, ms100, ms150, ms300, ms500, ms1000, spare2,
                          spare1 }bucketSizeDuration;

typedef enum liblte_rrc_periodic_bsr_timer_text {  sf5,     sf10,     sf16,     sf20,
                                            sf32,     sf40,     sf64,     sf80,
                                            sf128,    sf160,    sf320,    sf640,
                                            sf1280,   sf2560, INFINITY,    SPARE}liblte_rrc_periodic_bsr_timer_text;

typedef enum liblte_rrc_delta_mcs_enabled_text { en0, en1 }liblte_rrc_delta_mcs_enabled_text;
